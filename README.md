...
该项目为全文识别高精版。文档示例，该示例**无法在线调试**，如需调试可下载到本地后替换 [AK](https://usercenter.console.aliyun.com/#/manage/ak) 以及参数后进行调试。
...
-  RecognizeAdvanced 全文识别高精版。文档示例，可以参考：[文档](https://next.api.aliyun.com/document/ocr-api/2021-07-07/RecognizeAdvanced)
